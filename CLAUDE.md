...
- 2026-09-24: **Ewige Tabelle** (Wunsch Projektinhaber) im Reiter „Tabelle“ → „Ewig“: Sieg 3 Punkte, Unentschieden 1, Niederlage 0; Sortierung Punkte → Siege → weniger Spiele; Filter „Gesamt“ oder einzelnes Jahr; enthält auch inaktive Spieler mit Spielen. Turniersieg = ein Sieg. Platz auch im Spielerprofil. `typedRoutes` abgeschaltet (Routen-Typen wurden vom Dev-Server wiederholt falsch erzeugt).
